# DrAnmar SafePlane Dissection Mechanism

The payload replaces the Panda hand at `panda_link8` and provides 17 controlled axes. Two distributed traction pads maintain counter-traction while the central field remains accessible to four dissection modalities:
