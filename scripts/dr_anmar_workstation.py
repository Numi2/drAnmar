...
<main>
  ...
  <aside>
    ...
    <section class="control-dock">
      ...
      <h2>Pointer / gamepad speed</h2><div class="card"><div class="speedbar"><button data-speed="0.35" data-shortcut="," onclick="setSpeed(0.35,this)">Precision <kbd>,</kbd></button><button class="active" data-speed="1" data-shortcut="." onclick="setSpeed(1,this)">Normal <kbd>.</kbd></button><button data-speed="1.7" data-shortcut="/" onclick="setSpeed(1.7,this)">Fast <kbd>/</kbd></button></div><div class="hint">Keyboard speed is independent: <kbd>1/2/3</kbd> for the left robot and <kbd>8/9/0</kbd> for the right.</div></div>
      ...
      <div id="gripperPanel"><h2>Grippers</h2><div class="card"><div class="grid two"><button id="gripOpenButton" data-shortcut="Space" onclick="toggleGrip(0)">Left robot toggle <kbd>Space</kbd></button><button id="gripCloseButton" class="primary" data-shortcut="Enter" onclick="toggleGrip((latestStatus?.arms||1)>1?1:0)">Right robot toggle <kbd>Enter</kbd></button></div><div class="hint">Each thumb owns its nearest gripper. <kbd>Backspace</kbd> or <kbd>Esc</kbd> stops both robots instantly.</div></div></div>
      ...
      </div><div class="hint"><kbd>WASD + QE</kbd> left robot · <kbd>IJKL + UO</kbd> right robot · hold that hand’s <kbd>Shift</kbd> to rotate its wrist.</div></div>
    </section>
