...
<main>
  ...
  <aside>
    <section class="control-dock">
      ...
      </div><div class="pointer-strip"><span>Pointer / gamepad</span><div id="precisionModifier" class="modifier-chip"><kbd>⌥</kbd> Fine</div><div class="speedbar"><button data-speed="0.35" data-shortcut="," onclick="setSpeed(0.35,this)"><kbd>,</kbd></button><button class="active" data-speed="1" data-shortcut="." onclick="setSpeed(1,this)"><kbd>.</kbd></button><button data-speed="1.7" data-shortcut="/" onclick="setSpeed(1.7,this)"><kbd>/</kbd></button></div><button class="stop-center" data-shortcut="Backspace" onclick="emergencyStop()">Stop <kbd>Esc</kbd></button></div><div id="controlReadout" class="control-readout" aria-live="polite"><i></i><span>Ready · hold a key to move either instrument</span></div>
    </section>
