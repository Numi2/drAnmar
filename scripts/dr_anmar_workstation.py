...
<main>
  ...
  <aside>
    <div class="workstation-dockbar">
      ...
      <div class="dock-actions"><button id="panelToggle" data-shortcut="Tab" aria-expanded="false" onclick="toggleControlPanel()">Controls <kbd>Tab</kbd></button><button id="expertStart" class="primary" data-shortcut="F9" onclick="startExpert()">Watch expert <kbd>F9</kbd></button></div>
    </div>
