...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box} body{margin:0;background:var(--bg);color:var(--ink);font:15px/1.35 ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI";min-height:100vh}
    ...
    header{height:56px;gap:8px;padding:7px 12px;background:#171d21;border-bottom-color:#303a40}
    header .brand{display:none}
    .live{font-size:11px}.dot{width:7px;height:7px}.dot.ok{box-shadow:none}
    .header-camera-toolbar{gap:7px}.header-camera-toolbar .view-toolbar-row{gap:4px}.header-camera-toolbar button{min-height:32px;border-radius:9px;background:#242d32;border-color:#3b484f;color:#dde4e6;font-weight:650}.header-camera-toolbar button:hover{background:#2d383e;border-color:#71979d}.header-camera-toolbar .camera-tabs button.active,.header-camera-toolbar .view-presets button.active{background:#8bc6cd;border-color:#8bc6cd;color:#152126}
    .header-keyboard{border-radius:9px;background:#242d32;border-color:#3b484f;color:#dce4e6}
    main{display:grid;grid-template-columns:1fr;grid-template-rows:minmax(0,1fr) auto;height:calc(100vh - 56px);overflow:hidden}
    ...
    aside{max-height:70px;overflow:hidden;padding:8px 12px;border-left:0;border-top:1px solid #303a40;background:#171d21;transition:max-height .22s ease}
    aside>:not(.workstation-dockbar){display:none}
    .workstation-dockbar{display:flex;align-items:center;gap:8px;min-height:52px}
    .dock-hands{display:flex;align-items:center;gap:6px;min-width:0;flex:1}
    .dock-hand{display:flex;align-items:center;gap:7px;min-width:0;padding:7px 10px;border:1px solid #354147;border-radius:10px;background:#1d252a;color:#b7c2c5}
    .dock-hand b{color:#eff3f4;font-size:12px;white-space:nowrap}.dock-hand span{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:11px}
    .dock-actions{display:flex;align-items:center;gap:6px}.dock-actions button{min-height:38px;padding:0 12px;border-radius:10px;background:#242d32;border-color:#3c494f;color:#e9eef0;font-size:11px}.dock-actions .primary{background:#8bc6cd;border-color:#8bc6cd;color:#142126}
    ...
    .expert-demo{margin:0;padding:13px;border-color:#405157;border-radius:12px;background:#1b2328;box-shadow:none}.expert-head .eyebrow{color:#8bc6cd;font-family:inherit;font-size:9px;letter-spacing:.08em}.expert-head b{font-size:16px;font-weight:700}.expert-rail{display:none}.expert-instruction{min-height:0;margin-top:12px;padding:9px 10px;border-left-color:#8bc6cd;background:#151b1f;color:#bdc7ca;font-size:11px}.expert-actions{grid-template-columns:1fr 1fr}.expert-actions button{min-height:38px;border-radius:9px;background:#242d32;border-color:#3c494f}
    ...
    @media(max-width:920px){header{height:auto;min-height:56px;flex-wrap:wrap}.header-camera-toolbar{order:2;flex-basis:100%;overflow-x:auto}.header-keyboard,.live{display:none}main{display:grid;grid-template-columns:1fr;grid-template-rows:minmax(0,1fr) auto;height:calc(100vh - 104px)}.view{height:auto}.workstation-dockbar{overflow-x:auto}.dock-hand span{display:none}body.panel-open aside{grid-template-columns:1fr}.control-dock,.expert-demo,.session-details{grid-column:1!important}.session-details-grid{grid-template-columns:1fr 1fr}}
  </style>
</head>
<body>
...
<main>
  ...
  <aside>
    <div class="workstation-dockbar">
      ...
      <div class="dock-actions"><button id="panelToggle" data-shortcut="Tab" aria-expanded="false" onclick="toggleControlPanel()">Controls <kbd>Tab</kbd></button><button id="expertStart" class="primary" data-shortcut="F9" onclick="startExpert()">Watch expert <kbd>F9</kbd></button><button id="record" data-shortcut="Y" onclick="recording(true)">Record <kbd>Y</kbd></button></div>
    </div>
