...
def main() -> None:
    ...
    if organ_usd.is_file():
        ...
        if guide_kind in THREAD_GUIDE_KINDS:
            ...
            suture_width = 0.00085 if guide_kind == "hoop_threading" else 0.00105
            suture_blue = Gf.Vec3f(0.035, 0.22, 0.58)
            ...
            suture_shader.CreateInput("diffuseColor", Sdf.ValueTypeNames.Color3f).Set(suture_blue)
            suture_shader.CreateInput("emissiveColor", Sdf.ValueTypeNames.Color3f).Set(Gf.Vec3f(0.002, 0.012, 0.045))
    ...
    def update_suture_visual() -> None:
        ...
        strand_color = Gf.Vec3f(
            0.035 + 0.72 * color_scale,
            0.22 - 0.12 * color_scale,
    ...
    state = SharedState(
        ...
        anatomy_showcase=(
            str(procedure.get("anatomy_focus", "Dry-lab training field"))
            if procedure.get("hide_anatomy")
