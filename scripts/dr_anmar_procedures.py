...
ADVANCED_PROCEDURE_ROOMS: tuple[dict[str, Any], ...] = (
    {
        ...
        "title": "DrAnmar deformable wound-closure laboratory",
        "category": "Suturing and tissue mechanics",
        "difficulty": "Research foundation",
        "task": "Isaac-Reach-Dual-PSM-IK-Rel-v0",
        "anatomy_scene": "",
        "anatomy_focus": "DrAnmar open-incision suturable tissue",
        "robot": "Dual dVRK PSM",
        "instrument": "DrAnmar Needle, 4-0 suture and two needle drivers",
        "objective": "Manipulate two deformable wound flaps, establish counter-traction, study wound-edge approximation, and qualify needle and stitch mechanics without replacing any task-owned thread.",
        "interaction": "Native PhysX FEM owns intact deformation and two-way tool contact. Arbitrary puncture, thread passage and cutting remain fail-closed until the topology-capable MPM probe passes.",
        ...
        "steps": [
            ...
            step("counter_traction", "Establish counter-traction", "Use both instruments to load opposite flaps gently and observe deformation.", "two-way tissue contact"),
            step("approximate", "Approximate edges", "Bring the wound edges together without crushing or inverting them.", "gap reduction"),
            step("plan_bites", "Plan symmetric bites", "Present the DrAnmar Needle and select safe, repeatable entry and exit margins.", "needle trajectory and bite geometry"),
            step("qualify", "Qualify mechanics", "Record gap, force, deformation and damage evidence; do not claim puncture until the topology backend is qualified.", "fail-closed evidence"),
        ],
        "success_metrics": [
            "bilateral tissue contact",
            "wound gap reduction",
            "edge eversion",
            "contact force",
            "volume preservation",
...
PROCEDURE_SUITES: tuple[dict[str, Any], ...] = (
    {
        ...
        "rooms": ["needle-pickup", "needle-transfer", "dr-anmar-suturable-tissue", "needle-passing-regrasp", "nvidia-strand-ring-threading", "nvidia-native-surgical-bench"],
    },
    {
        ...
        "rooms": ["synthetic-anatomy-navigation", "ultrasound-guided-access", "complication-recovery", "liver-retraction"],
    },
    {
