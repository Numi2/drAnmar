...
ADVANCED_PROCEDURE_ROOMS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "objective": "Close the Dr.Anmar suturable-tissue incision with seven guided staple placements that approximate the wound edges before firing and retain the PhysX FEM tissue after release without requiring a gun-gripping robot.",
        "interaction": "A six-DOF proportional-velocity indexing fixture holds the stapler housing over the real Dr.Anmar open-incision tissue. Each bounded cycle first drives paired tissue-approximation constraints, then presses and deploys a formed rigid staple with two retained FEM attachment bands before releasing and advancing 6 mm.",
        ...
        "steps": [
            ...
            step("approximate", "Approximate wound edges", "Start one bounded cycle and observe the paired FEM attachment bands draw both wound edges together before trigger travel begins.", "measured tissue gap"),
            step("deploy", "Form and retain", "Confirm one threshold crossing consumes exactly one simulated staple, enables its rigid collider and retains both tissue attachment bands after the fixture releases.", "deterministic deployment and retention"),
            step("repeat", "Complete the closure line", "Repeat across all seven 6 mm-spaced stations; use Previous or Next to inspect or resume a station.", "guided spacing and retained closure"),
            step("review", "Review evidence", "Review mechanism, FEM displacement, residual gap and retention evidence; puncture, metal plasticity and clinical closure strength remain outside this simulation boundary.", "research evidence"),
        ],
        "success_metrics": [
