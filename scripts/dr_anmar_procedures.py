...
PROCEDURE_ROOMS: tuple[dict[str, Any], ...] = (
    {
        ...
        "bench_asset_catalog": (
            ...
            {
                "id": "skin_stapler",
                "title": "Dr.Anmar skin stapler",
                "description": "Loaded rigid skin stapler for perception, grasping, handover and closure-task research.",
                "path": "Props/SurgicalClosure/SkinStapler/skin_stapler_rigid_proxy.usda",
                "provider": "dr_anmar",
                "state": "loaded",
                "default": False,
            },
            {
                "id": "dr_anmar_needle",
                "title": "Dr.Anmar needle",
                "description": "Standalone curved needle with matched Dr.Anmar geometry and rigid-body collision.",
                "path": "assets/dr_anmar/needle/DrAnmarNeedleOnly.usda",
            ...
            },
            {
                ...
                "path": "assets/dr_anmar/needle/DrAnmarNeedle.usda",
                "provider": "dr_anmar_repository",
                "physics": "physx",
                "default": False,
            },
            {
                "id": "dr_anmar_tissue",
                "title": "Dr.Anmar suturable tissue",
                "description": "Open-incision collision field for approach, contact and bite-path planning.",
                "path": "assets/dr_anmar/tissue/DrAnmarSuturableTissue.usda",
                "provider": "dr_anmar_repository",
                "default": False,
            },
            {
                "id": "vascular_clip",
                "title": "Dr.Anmar vascular clip",
                "description": "Rigid one-piece clip for pickup, handover, alignment and contact research.",
                "path": "assets/dr_anmar/hemostasis/DrAnmarVascularClip.usda",
                "provider": "dr_anmar_repository",
                "default": False,
            },
            {
                "id": "laparotomy_sponge",
                "title": "Dr.Anmar laparotomy sponge",
                "description": "Dry folded rigid proxy for surgical-count, retrieval and handover practice.",
                "path": "Props/SurgicalCount/LaparotomySponge/lap_sponge_folded_proxy.usda",
                "provider": "dr_anmar",
                "state": "dry",
                "default": False,
            },
