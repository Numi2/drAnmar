...
PROCEDURE_SUITES: tuple[dict[str, Any], ...] = (
    {
        ...
        "rooms": ["nvidia-strand-ring-threading", "needle-pickup", "needle-passing-regrasp", "suture-threading-path", "running-suture", "intracorporeal-knot", "anastomosis-leak-test"],
    },
    {
        "id": "vascular-suite",
