...
PROCEDURE_ROOMS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "interaction": "Physical needle manipulation with OpenUSD pathway markers and ordered waypoint scoring.",
        ...
        "truth_note": "This room trains needle-path control. The guide path does not yet simulate puncture, thread tension, or tissue tearing.",
    },
    {
