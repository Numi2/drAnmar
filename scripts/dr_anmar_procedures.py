            ...
            *BENCH_ROBOT_SYSTEM_CATALOG,
            {
                ...
                "path": "Props/SurgicalClosure/Needle/dranmar_needle.usda",
                "provider": "dr_anmar",
                "default": False,
            },
            {
                "id": "dr_anmar_needle_thread_coiled",
                "title": "Dr.Anmar needle + thread · coiled",
                "description": "New needle with 180 mm braided 4-0 thread, 120 physical segments and a coiled starting configuration.",
                "path": "Props/SurgicalClosure/NeedleThread/dranmar_needle_thread.usda",
                "provider": "dr_anmar",
                "representation": "maximal_coordinate_d6_chain",
                "default": False,
            },
            {
                "id": "dr_anmar_needle_thread_extended",
                "title": "Dr.Anmar needle + thread · extended",
                "description": "The same physical needle-thread mechanism laid out for pull-through, tension and regrasp experiments.",
                "path": "Props/SurgicalClosure/NeedleThread/dranmar_needle_thread_extended.usda",
                "provider": "dr_anmar",
                "representation": "maximal_coordinate_d6_chain",
                "default": False,
            },
            {
                "id": "dr_anmar_needle_thread_proxy",
                "title": "Dr.Anmar needle + thread · rigid proxy",
                "description": "Stable one-body representation for perception, handover, positioning and dataset generation.",
                "path": "Props/SurgicalClosure/NeedleThread/dranmar_needle_thread_rigid_proxy.usda",
                "provider": "dr_anmar",
...
ADVANCED_PROCEDURE_ROOMS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "steps": [
            ...
            step("assess", "Assess modeled physiology", "Review the shared patient perfusion, bleeding, fluid-balance and vital-sign state. The standalone multimodal perfusion robot is not a validated sensor bridge.", "shared reduced-order physiology"),
            step("close", "Record closure boundary", "Use only evidence-qualified repair mechanics; otherwise record closure as unverified before saving the final patient state.", "fail-closed closure status and final patient state"),
        ],
        "success_metrics": [
    ...
    },
    {
        ...
        "category": "Closure-device mechanism bench",
        ...
        "objective": "Exercise seven guided stapler placements while measuring trigger sequencing and a prescribed FEM approximation pose; staple-tissue retention remains unmodeled.",
        "interaction": "A six-DOF proportional-velocity indexing fixture holds the stapler housing over the Dr.Anmar open-incision tissue. Each bounded cycle drives prescribed tissue-approximation targets, then places a kinematic formed-staple visual before releasing and advancing 6 mm. No load-bearing staple-to-tissue attachment is created.",
        ...
        "bench_core_assets": (
            ...
            {"id": "table", "title": "Surgical table"},
            {"id": "stapler_fixture", "title": "Dr.Anmar instrumented fixture"},
        ),
        "bench_asset_catalog": (),
        "psm_root_spacing_m": 0.20,
        "hide_anatomy": True,
        ...
        "interactive_camera_width_px": 960,
        "interactive_camera_height_px": 640,
        "interactive_camera_eye_m": (0.34, 0.24, 0.22),
        "interactive_camera_target_m": (0.015, 0.0, 0.035),
        "interactive_rgb_only": True,
        "interactive_multiview": True,
        "single_active_camera_renderer": True,
        "steps": [
            ...
            step("approximate", "Approximate wound edges", "Start one bounded cycle and observe the prescribed FEM nodal targets draw both wound edges together before trigger travel begins.", "imposed tissue gap"),
            step("deploy", "Place staple visual", "Confirm one threshold crossing consumes exactly one simulated staple and enables its kinematic rigid visual; no staple-tissue attachment is created.", "deterministic visual placement"),
            step("repeat", "Complete the placement line", "Repeat across all seven 6 mm-spaced stations; use Previous or Next to inspect or resume a station.", "guided visual spacing"),
            step("review", "Review boundary", "Review mechanism sequencing, FEM displacement and imposed residual gap. Retention, puncture, forming and closure strength remain unverified.", "source-honest research boundary"),
        ],
        "success_metrics": [
            "trigger target tracking",
            "pusher synchronization",
            "single deployment per full cycle",
            "partial-stroke rejection",
            "rearm behavior",
            "cycle repeatability",
            "seven-station placement completion",
            "6 mm simulated spacing",
            "pre-fire wound-edge approximation",
            "prescribed FEM closure-pose repeatability",
        ],
    },
    {
