    ...
    [
        {
            ...
            "lessons": [
                ...
                },
                {
                    ...
                    "video": None,
                    "mode": "live",
                    "summary": "Control a threaded curved needle with two instruments, pass the strand around the ring, and form a controlled throw.",
                    "goal": "Complete a physical handoff, ring pass, and stable throw while maintaining strand control.",
                    "concepts": ["hand-eye coordination", "thread control", "handoff", "ring pass", "knot throw"],
                },
                {
...
LESSON_GUIDES = {
    ...
    "needle-hoop-threading-live": {
        ...
        "practice": "Acquire the threaded needle, transfer it between instruments, guide the strand around the ring, and form one controlled throw.",
        "steps": ["Grasp the needle body without pinching the strand.", "Establish receiver custody before releasing the first instrument.", "Guide the strand through and around the ring with counter-traction.", "Cross and set one controlled throw."],
        "success_checks": ["The needle remains under instrument control.", "The strand stays attached during the handoff.", "The strand clears the ring and the throw remains stable."],
