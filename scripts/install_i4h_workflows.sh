...
release="${DR_ANMAR_I4H_RELEASE:-v0.5.0}"
holohub_cli_commit="${DR_ANMAR_HOLOHUB_CLI_COMMIT:-5c49897bd229d4ce46cbcd4a68c640f6258233f7}"
...
if [[ ! -f "$root/tools/utilities/cli/holohub.py" ]]; then
